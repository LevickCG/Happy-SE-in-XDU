...
###7.6
1?00  ???X  XXXX  XXXX  XXXX
其中第一个问号"?"代表A18，它可以取1或0
...
###7.16
	1. 1111 110X XXXX XXXX XXXX，其中X表示A0~A12，故占用内存地址为FC000H~FDFFFH
	2.需要两片该SRAM芯片。0011 00?X XXXX XXXX XXXX 其中X表示A0~A12，A13是"?"表示片选信号
...
###7.22
	...
	(2)ABCDE (H) = 1010 101{1} (11)<00 1101 1110> (B)，其中{}内为区内组号(第"1"组)，拼接主存区号和组内块号，得到1010 101 11->0001 0101 0111->157H，对应的第"1"组的157H是第"2"块,故组号和区内组号拼上块内地址即为0001 1000 1101 1110->18DE (H)
